...
/* Define username and associated password array */$logins = array('Admin' => 'admin1234','username1' => 'password1','username2' => 'password2');
...
<form action="" method="post" name="Login_Form">
  <table width="400" border="0" align="center" cellpadding="5" cellspacing="1" class="Table">
    ...
    <?php } ?>
    <tr>
      <td colspan="2" align="left" valign="top" style="text-align: center"><h3>Login</h3></td>
    </tr>
    <tr>
    ...
    <tr>
      <td> </td>
      <td><input name="Submit" type="submit" value="Login" style= "background: blue" class="Button3"></td>
    </tr>
  </table>
</form>
<p style= "text-align: center">Username: Admin <br> Password: admin1234</p>
